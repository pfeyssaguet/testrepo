        ...
        foreach ($properties as $property) {
            ...
            if ($annotation instanceof Property) {
                ...
                if (in_array($type, self::ALLOWED_TYPES)) {
                    ...
                    $getValue = static function ($value) use ($type, $name, $annotation) {
                        if (! is_scalar($value) && ! ($value === null && $annotation->nullable)) {
    ...
    public function jsonSerialize(): array
    {
        ...
        foreach ($properties as $property) {
            ...
            if ($annotation instanceof Property) {
                ...
                if ($annotation->required !== false || $property->getValue($this) !== null) {
